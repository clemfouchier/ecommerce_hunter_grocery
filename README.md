# Projet analyse des données du site web de l'épicerie en ligne Hunter Grocery
...
Plus de la moitié des produits achetés concernent des produits frais, à commencer par les fruits et légumes, mais aussi les produits laitiers, et les produits de boulangerie.

Par ailleurs, lorsque l'on regarde les produits qui ont été re-commandés, c'est-à-dire les produits qui ont été à nouveau achetés par les utilisateurs, nous constatons qu'ils re-commandent davantage les produits frais, notamment les fruits et légumes et les produits laitiers.

Enfin, lorsque l'on zoom sur les produits mis en premier dans le panier, nous voyons que les boissons se placent en troisième position, prenant la place des snacking. Il s'agit donc de produits attractifs, avec les produits frais dont les fruits et légumes et les produits laitiers. Ils seront potentiellement plus déclancheurs de l'envie de commander. 
